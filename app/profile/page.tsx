    ...
    <div className="p-8 max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Gestiona tu información personal y propuesta de valor.
        </p>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tus datos básicos de contacto e identificación.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs bg-muted px-2 py-1 rounded mt-1 inline-block uppercase">
                  {profile.role}
                </div>
              </div>
            </div>
        ...
        {message && (
          <Alert variant={message.type === 'error' ? 'destructive' : 'default'} className={message.type === 'success' ? 'border-green-500 text-green-700 bg-green-50 dark:bg-green-900/20 dark:text-green-300' : ''}>
