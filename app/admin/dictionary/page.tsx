    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Gestiona las tecnologías y procesos que el sistema debe detectar.
        </p>
      </div>
        ...
        <TabsContent value="technologies" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configura las empresas de tecnología y sus productos asociados.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <VendorsTable />
        ...
        <TabsContent value="processes" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Define los procesos clave y sus palabras clave asociadas.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ProcessesTable />
