...
const handler = createMcpHandler(
            ...
            nextStep:
              people.length === 0
                ...
                : people.length >= limit
                  ...
                  : "Presentá los perfiles al usuario en tabla: NOMBRE · CARGO · EMPRESA · PAÍS · EMAIL PERSONAL · TELÉFONO. Aclarale cuando el mail sea corporativo (emailIsPersonal:false).",
          }
        })
    )
  ...
  },
  {
    ...
    instructions: [
      ...
      "Contacto PERSONAL: `personalEmail` es el mail de dominio personal (gmail/hotmail/...). Si la persona no tiene uno, viene null y se expone `workEmail` (corporativo) con `emailIsPersonal:false`; presentalo aclarando que es corporativo. `personalPhone` prioriza el teléfono de tipo móvil/personal. Nunca inventes datos de contacto: si no están, decilo.",
