-- Script 092: Fix current_employees_count to properly filter by is_current_employee
-- The previous script broke the current employees counter
...
BEGIN
  ...
  SELECT 
    ...
    -- Current employees: señales donde is_current_employee = TRUE
