-- BUG FIX 1: Export de bookmarks no traia telefonos y faltaban email2 + status
--
-- El RPC get_bookmark_export_data devolvia solo `email: COALESCE(email1, email2)` y
-- no exponia phone1/phone2 ni la validez (status) ni el tipo de cada email.
--
-- Esta version expone, por cada contacto con senales:
...
--
-- Mantiene la logica de scope filter (filterSignalIds) intacta de v137.
